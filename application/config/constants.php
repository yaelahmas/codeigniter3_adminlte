...
defined('MAILPATH')      		or define('MAILPATH', '/usr/sbin/sendmail');
...
defined('SMTP_USER')      		or define('SMTP_USER', 'okx2024001@gmail.com');
defined('SMTP_PASS')      		or define('SMTP_PASS', 'ftrmgrjbxpzkzjqz');
defined('SMTP_CRYPTO')      	or define('SMTP_CRYPTO', 'ssl');
defined('FROM_ADDRESS')    		or define('FROM_ADDRESS', 'noreplay@example.com');
defined('FROM_NAME')      		or define('FROM_NAME', 'CodeIgniter 3');

defined('ADMINISTRATOR') 		or define('ADMINISTRATOR', 1);
defined('USER') 				or define('USER', 2);
defined('WEB_DEVELOPER') 		or define('WEB_DEVELOPER', 3);
 ...
 * */
defined('EXPIRATION') 				or define('EXPIRATION', 1800);
